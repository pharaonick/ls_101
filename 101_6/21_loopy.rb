...
# is it helpful to have this as a method?
# Seems kinda unnecessary and perhaps even confusing...
...
# very loopy because of the break condition needed for player bust...
loop do
  loop do
