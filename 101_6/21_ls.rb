...
def display_result(dealer_tot, player_tot, score)
...
running_score = {'Dealer' => 0, 'Player' => 0}
...
loop do
  ...
  prompt "CURRENT SCORE. Dealer: #{running_score["Dealer"]}. Player: #{running_score["Player"]}."
  ...
  if busted?(player_total)
    ...
    display_result(dealer_total, player_total, running_score)
