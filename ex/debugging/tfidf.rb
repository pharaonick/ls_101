...
# THIS DOESN'T EXCLUDE ENDING PUNCTUATION
# WHAT ABOUT PLURALS?
...
def idf(term, documents)
  ...
  # should add guard clause for dividing by 0...
  Math.log(number_of_documents.to_f / number_of_documents_with_term.to_f)
  # actually only need to convert one to float, or use `Integer#fdiv`
end
...
# expected outputs:
puts tfidf("cat", document1, documents) # ~ 1.2 ACTUAL 0.0 ****
puts tfidf("cat", document2, documents) # ~ 1.6 ACTUAL 0.0 ****
puts tfidf("cat", document3, documents) # 0 ACTUAL 0.0

puts tfidf("quantum", document1, documents) # ~ 5.5 ACTUAL 5.493061443340549
puts tfidf("quantum", document2, documents) # 0 ACTUAL 0.0
puts tfidf("quantum", document3, documents) # 0 ACTUAL 0.0

puts tfidf("mastery", document1, documents) # 0 ACTUAL 0.0
puts tfidf("mastery", document2, documents) # 0 ACTUAL 0.0
puts tfidf("mastery", document3, documents) # ~ 3.3 ACTUAL 3.295836866004329

puts tfidf("some", document1, documents) # 0 ACTUAL 0.0
puts tfidf("some", document2, documents) # ~ 0.4 ACTUAL 0.0 ****
puts tfidf("some", document3, documents) # ~ 0.4 ACTUAL 0.0 ****
